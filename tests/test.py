'''
Test script
*WARNING* Don't run this on a production theholyroger server! *WARNING*
...
# from theholyrogerrpc.exceptions import TheHolyRogerException, InsufficientFunds 
...
if __name__ == "__main__":
    ...
    theholyrogeraddress = conn.getnewaddress(account)
    conn.setaccount(theholyrogeraddress, account)
    ...
    #conn.sendtoaddress(theholyrogeraddress, amount, comment=None, comment_to=None)
    conn.getreceivedbyaddress(theholyrogeraddress)
